  ...
  return (
    <div name="about" className="w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white">
        <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify center w-full h-full">
            ...
            <p className="text-xl mt-20">I am a Graduate in B.tech Cse ,From Uttaranchal University in <Dehradun></Dehradun>, having front end developement skills like- javascript, html, css, tailwind css, java ,react.js.<br/>
