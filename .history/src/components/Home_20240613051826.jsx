       ...
       <div  className="max-w-screen-lg mx-auto flex flex-col item-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
            ...
            <div>
                <button>
                    Portfolio
                    <span pan className="group-hover:rotate-90 duration-300">
        ...
        <div>
            <img src={HeroImage} alt="my profile" className=" rounded-full mx-auto  w-2/3 max-w-2xl py-5 md:w-full pe-8 shadow-xl  "/>
        </div>
      </div>
    </div>
  )
